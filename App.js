...
const App = () => {
  ...
  const origin = {latitude: 30.6575589, longitude: 76.7245736}; // besttech
  const destination = {latitude: 30.6735755, longitude: 76.7376952}; // itecno labs
  const GOOGLE_MAPS_APIKEY = 'YOUR_API_KEY';
 // Function to display notification
const showProximityNotification = async () => {
  try {
